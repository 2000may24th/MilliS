...
const I18N = {
  ko: {
    ...
    "intro.page1.note": "iPadOS에서는 Dynamic Island를 포함한 일부 기능 제한",
    ...
    "intro.page3.note": "Apple의 인터페이스 관리 정책으로 Dynamic Island 등 Live Activities에서 1s 미만의 단위로 서버 시간 미표시, 연속으로 최대 8시간 동작",
